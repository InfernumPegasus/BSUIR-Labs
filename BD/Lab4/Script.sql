...
-- INSERT INTO "TourAgency"."Booking" ("StartDate", "EndDate", "Status", "ClientID", "HotelID", "TourID", "VoucherID")
-- SELECT 
...
--         ELSE 'Cancelled'
--     END AS Status,
-- 	(random() * 30) AS "ClientID",
-- 	(random() * 30) AS "HotelID",
-- 	(random() * 30) AS "TourID",
-- 	(random() * 30) AS "VoucherID"
...
-- INSERT INTO "TourAgency"."Client" ("FirstName", "SecondName", "ThirdName", "PhoneNumber", "PaymentID")
-- SELECT
...
-- INSERT INTO "TourAgency"."Voucher" ("StartDate", "EndDate", "Status", "PaymentID")
-- SELECT 
--     DATE '2022-01-01' + CAST(random() * (DATE '2023-12-31' - DATE '2023-06-01') AS INTEGER) AS StartDate,
--     DATE '2023-01-01' + CAST(random() * (DATE '2023-12-31' - DATE '2022-01-01') AS INTEGER) AS EndDate,
--     CASE 
