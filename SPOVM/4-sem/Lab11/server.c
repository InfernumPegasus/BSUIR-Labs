...
int clientCompare(struct sockaddr_in client1, struct sockaddr_in client2) {
    ...
    return strncmp((char *) &client1.sin_addr.s_addr, (char *) &client2.sin_addr.s_addr,
                   sizeof(unsigned long)) != 0 &&
           strncmp((char *) &client1.sin_port, (char *) &client2.sin_port,
                   sizeof(unsigned short)) != 0 &&
           strncmp((char *) &client1.sin_family, (char *) &client2.sin_family,
                   sizeof(unsigned short)) != 0;
}
